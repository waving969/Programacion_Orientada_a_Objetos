 ...
 * @author fvelasco
 */
public class DadoGUI extends JDialog {
  
  private static DadoGUI instance = null;
  ...
  public static void createInstance (JFrame parent) {
    if (instance == null)
      instance = new DadoGUI (parent);
  }
  
  public static DadoGUI getInstance() {
      return instance;
  }
